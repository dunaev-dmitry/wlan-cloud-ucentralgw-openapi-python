...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_access_token  # this is an instance of the class Endpoint
        api_instance.get_access_token()  # this invokes api_instance.get_access_token.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_access_token.callable or self.callable in this class
